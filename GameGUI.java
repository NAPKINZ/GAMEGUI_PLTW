...
public class GameGUI extends JComponent
{
  ...
  public GameGUI()
  {
    ...
    try {
      bgImage = ImageIO.read(new File("C:\\Users\\Owner\\Desktop\\homework\\CSA\\src\\grid.png"));
    } catch (Exception e) {
      System.err.println("Could not open file grid.png");
    }      
    try {
      prizeImage = ImageIO.read(new File("C:\\Users\\Owner\\Desktop\\homework\\CSA\\src\\coin.png"));
    } catch (Exception e) {
    ...
    try {
      player = ImageIO.read(new File("C:\\Users\\Owner\\Desktop\\homework\\CSA\\src\\player.png"));
    } catch (Exception e) {
  ...
  */
  ...
  public void setY(int y){
    ...
    public void keyPressed(KeyEvent e) {
        ...
        {
            EscapeRoom.score += movePlayer(0,-SPACE_SIZE);
        }
        else if (key == KeyEvent.VK_A)
        {
            EscapeRoom.score += movePlayer(-SPACE_SIZE,0);
        }
  ...
  /**
   * Set the designated number of prizes in the   This can be used to customize the gameboard configuration.
   * <P>
  ...
  /**
   * Set the designated number of traps in the  This can be used to customize the gameboard configuration.
   * <P>
  ...
  /**
   * Set the designated number of walls in the  This can be used to customize the gameboard configuration.
   * <P>
   * precondition t must be a positive, non-zero integer
   * <P>
  ...
  /**
   * Reset the board to replay existing  The method can be called at any time but results in a penalty if called
